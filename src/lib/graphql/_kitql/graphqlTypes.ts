...
export type AssociationFieldsFragment = { __typename?: 'AssociationNode', id: string, name: string, description?: string | null, imageIds: Array<string>, thumbnailId?: string | null, markdownNotes?: string | null, lockTime?: any | null, lockedBySelf?: boolean | null, lockUser?: { __typename?: 'UserNode', id: string, username: string } | null };
...
export const ArtifactCreate = gql`
    mutation artifactCreate($name: String, $description: String, $thumbnailId: String, $markdownNotes: String, $imageIds: [String]) {
  artifactCreate(
...
export const AssociationCreate = gql`
    mutation associationCreate($name: String, $description: String, $thumbnailId: String, $markdownNotes: String, $imageIds: [String]) {
  associationCreate(
    input: {name: $name, description: $description, thumbnailId: $thumbnailId, markdownNotes: $markdownNotes, imageIds: $imageIds}
  ) {
    ok
...
export const ItemCreate = gql`
    mutation itemCreate($name: String, $description: String, $thumbnailId: String, $markdownNotes: String, $imageIds: [String]) {
  itemCreate(
    input: {name: $name, description: $description, thumbnailId: $thumbnailId, markdownNotes: $markdownNotes, imageIds: $imageIds}
  ) {
    ok
...
export const NpcCreate = gql`
    mutation npcCreate($name: String, $description: String, $thumbnailId: String, $markdownNotes: String, $imageIds: [String]) {
  npcCreate(
    input: {name: $name, description: $description, thumbnailId: $thumbnailId, markdownNotes: $markdownNotes, imageIds: $imageIds}
  ) {
    ok
...
export const PlaceCreate = gql`
    mutation placeCreate($name: String, $description: String, $thumbnailId: String, $markdownNotes: String, $imageIds: [String]) {
  placeCreate(
    input: {name: $name, description: $description, thumbnailId: $thumbnailId, markdownNotes: $markdownNotes, imageIds: $imageIds}
  ) {
    ok
